...
public class BasketItemFactoryTests {
    ...
    private void assertBasketItemParsedCorrectly(int expectedQuantity, String expectedDescription, float expectedPrice, 
            Set<ProductTaxRateType> expectedTaxRates, BasketItems item) {
